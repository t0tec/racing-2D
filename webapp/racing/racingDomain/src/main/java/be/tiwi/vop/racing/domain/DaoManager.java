...
import be.tiwi.vop.racing.domain.dao.CircuitDao;
import be.tiwi.vop.racing.domain.dao.EventDao;
import be.tiwi.vop.racing.domain.dao.GhostDao;
import be.tiwi.vop.racing.domain.dao.ObstacleDao;
...
import be.tiwi.vop.racing.domain.dao.TournamentDao;
import be.tiwi.vop.racing.domain.dao.UserDao;
import be.tiwi.vop.racing.domain.dao.impl.CircuitDaoJdbcImpl;
import be.tiwi.vop.racing.domain.dao.impl.EventDaoJdbcImpl;
import be.tiwi.vop.racing.domain.dao.impl.GhostDaoJdbcImpl;
import be.tiwi.vop.racing.domain.dao.impl.ObstacleDaoJdbcImpl;
import be.tiwi.vop.racing.domain.dao.impl.RaceDaoJdbcImpl;
import be.tiwi.vop.racing.domain.dao.impl.ResultDaoJdbcImpl;
import be.tiwi.vop.racing.domain.dao.impl.TileDaoJdbcImpl;
import be.tiwi.vop.racing.domain.dao.impl.TournamentDaoJdbcImpl;
import be.tiwi.vop.racing.domain.dao.impl.UserDaoJdbcImpl;
